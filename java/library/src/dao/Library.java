...
public class Library {
    ...
    public boolean canModifyClient(Client client){
        return client.getBorrowedItemIds().size()==0;
    }
    
    public boolean canModifyItem(LibraryItem item){
        return item.getAvailable()==item.getStock();
    }
}
